...
export const Button: FC<IProps> = ({ text, onClick }) => {
  return (
    <button onClick={onClick} className="ease group relative z-30 box-border inline-flex w-auto undefined cursor-pointer items-center justify-center overflow-hidden rounded bg-indigo-600 bg-gradient-to-r from-pink-500 to-violet-500 px-8 py-3 font-bold text-white transition-all duration-300 focus:outline-none">
      ...
      <span className="relative z-20 flex items-center font-semibold">Buy Now</span>
    </button>
